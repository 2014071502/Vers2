...
public class Proceed extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<img src = 'http://localhost:8080/FINALver2/FT.jpg'<br>");
		out.println("<li>First Name: <input type = 'text' name = 'fname'<br>");
		out.println("<li>Last Name: <input type = 'text' name = 'lname'<br>");
